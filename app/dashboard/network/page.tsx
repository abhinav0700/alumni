      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          <p className="text-muted-foreground mt-2">
            Connect with fellow alumni and current students from Sri Venkateswara College of Engineering.
          </p>
        </div>
                ...
                <CardContent className="space-y-3">
                  ...
                  <div className="flex gap-2 pt-2">
                    <Button
                      ...
                      className="flex-1"
                      onClick={() =>
                        (window.location.href = `mailto:${profile.email}?subject=Connection Request from ${user?.email}&body=Hi ${profile.full_name},%0D%0A%0D%0AI would like to connect with you through the Sri Venkateswara College of Engineering Alumni Platform.%0D%0A%0D%0ABest regards`)
                      }
                    >
